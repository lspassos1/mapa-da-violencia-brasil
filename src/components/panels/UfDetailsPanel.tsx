...
export function UfDetailsPanel({ indicators, indicatorKey, ufNome, selectedState, datum }: UfDetailsPanelProps) {
  ...
  return (
    <div className="rounded-lg border border-line bg-panel p-4 backdrop-blur">
      ...
      <div className="mt-2 flex items-start gap-2 rounded-md border border-edge bg-[rgba(86,91,99,.12)] p-2 text-[11px] leading-snug text-sec/90">
      ...
      {selectedState && datum ? (
        <div className="mt-3 space-y-3 text-sm text-sec">
        ...
        <p className="mt-3 text-sm text-ter">
